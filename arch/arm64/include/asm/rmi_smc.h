...
#define SMC_RMI_SHARED_DATA_CREATE		SMC_RxI_CALL(0x0156)
#define SMC_RMI_SHARED_DATA_DESTROY		SMC_RxI_CALL(0x016b)
...
#define SMC_RMI_RTT_INIT_SHARED_RIPAS		SMC_RxI_CALL(0x0160)
...
#define SMC_RMI_MAP_SHARED_MEM_AS_RO		SMC_RxI_CALL(0x0163)
//#define SMC_RMI_UNMAP_SHARED_RMEM		SMC_RxI_CALL(0x016a) // c400016b
#define SMC_RMI_RTT_UNMAP_UNPROTECTED	SMC_RxI_CALL(0x0162)
#define SMC_RMI_VERSION			SMC_RxI_CALL(0x0150)
#define SMC_RMI_UNMAP_SHARED_MEM SMC_RxI_CALL(0x016a)
