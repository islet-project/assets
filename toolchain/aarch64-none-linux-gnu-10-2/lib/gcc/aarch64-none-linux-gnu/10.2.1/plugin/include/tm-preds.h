/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/tmp/dgboter/bbs/build04--cen7x86_64/buildbot/cen7x86_64--aarch64-none-linux-gnu/build/src/gcc/gcc/config/aarch64/aarch64.md'.  */
