...
enum opt_code
{
  ...
  OPT_r = 1746,                              /* -r */
  OPT_remap = 1747,                          /* -remap */
  OPT_reverse_sort = 1748,                   /* -reverse-sort */
  OPT_s = 1749,                              /* -s */
  OPT_save_temps = 1750,                     /* -save-temps */
  OPT_save_temps_ = 1751,                    /* -save-temps= */
  OPT_shared = 1752,                         /* -shared */
  OPT_shared_libgcc = 1753,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1754,               /* -shared-libphobos */
  OPT_size_sort = 1755,                      /* -size-sort */
  /* OPT_specs = 1756, */                    /* -specs */
  OPT_specs_ = 1757,                         /* -specs= */
  OPT_static = 1758,                         /* -static */
  OPT_static_libasan = 1759,                 /* -static-libasan */
  OPT_static_libgcc = 1760,                  /* -static-libgcc */
  OPT_static_libgfortran = 1761,             /* -static-libgfortran */
  OPT_static_libgo = 1762,                   /* -static-libgo */
  OPT_static_libhwasan = 1763,               /* -static-libhwasan */
  OPT_static_liblsan = 1764,                 /* -static-liblsan */
  OPT_static_libmpx = 1765,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1766,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1767,               /* -static-libphobos */
  OPT_static_libstdc__ = 1768,               /* -static-libstdc++ */
  OPT_static_libtsan = 1769,                 /* -static-libtsan */
  OPT_static_libubsan = 1770,                /* -static-libubsan */
  OPT_static_pie = 1771,                     /* -static-pie */
  /* OPT_std_c__03 = 1772, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1773, */                /* -std=c++0x */
  OPT_std_c__11 = 1774,                      /* -std=c++11 */
  OPT_std_c__14 = 1775,                      /* -std=c++14 */
  OPT_std_c__17 = 1776,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1777, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1778, */                /* -std=c++1z */
  OPT_std_c__20 = 1779,                      /* -std=c++20 */
  OPT_std_c__23 = 1780,                      /* -std=c++23 */
  /* OPT_std_c__2a = 1781, */                /* -std=c++2a */
  /* OPT_std_c__2b = 1782, */                /* -std=c++2b */
  OPT_std_c__98 = 1783,                      /* -std=c++98 */
  OPT_std_c11 = 1784,                        /* -std=c11 */
  OPT_std_c17 = 1785,                        /* -std=c17 */
  /* OPT_std_c18 = 1786, */                  /* -std=c18 */
  /* OPT_std_c1x = 1787, */                  /* -std=c1x */
  OPT_std_c2x = 1788,                        /* -std=c2x */
  /* OPT_std_c89 = 1789, */                  /* -std=c89 */
  OPT_std_c90 = 1790,                        /* -std=c90 */
  OPT_std_c99 = 1791,                        /* -std=c99 */
  /* OPT_std_c9x = 1792, */                  /* -std=c9x */
  OPT_std_f2003 = 1793,                      /* -std=f2003 */
  OPT_std_f2008 = 1794,                      /* -std=f2008 */
  OPT_std_f2008ts = 1795,                    /* -std=f2008ts */
  OPT_std_f2018 = 1796,                      /* -std=f2018 */
  OPT_std_f95 = 1797,                        /* -std=f95 */
  OPT_std_gnu = 1798,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1799, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1800, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1801,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1802,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1803,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1804, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1805, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 1806,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 1807,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 1808, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 1809, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 1810,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1811,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1812,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1813, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1814, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1815,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1816, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1817,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1818,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1819, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1820, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1821,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1822, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1823, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1824, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1825, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1826, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1827,                     /* -std=legacy */
  OPT_stdlib_ = 1828,                        /* -stdlib= */
  OPT_symbol_ = 1829,                        /* -symbol= */
  OPT_symbolic = 1830,                       /* -symbolic */
  OPT_t = 1831,                              /* -t */
  OPT_time = 1832,                           /* -time */
  OPT_time_ = 1833,                          /* -time= */
  OPT_traditional = 1834,                    /* -traditional */
  OPT_traditional_cpp = 1835,                /* -traditional-cpp */
  OPT_tree_stats = 1836,                     /* -tree-stats */
  OPT_trigraphs = 1837,                      /* -trigraphs */
  OPT_type_stats = 1838,                     /* -type-stats */
  OPT_u = 1839,                              /* -u */
  OPT_undef = 1840,                          /* -undef */
  OPT_v = 1841,                              /* -v */
  OPT_version = 1842,                        /* -version */
  OPT_w = 1843,                              /* -w */
  OPT_wrapper = 1844,                        /* -wrapper */
  OPT_x = 1845,                              /* -x */
  OPT_z = 1846,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
