...
#define RSIIO_CHANNEL_GEN_REPORT    _IOWR('x', 197, struct rsi_cloak)  // read the counterparty's report
#define RSIIO_CHANNEL_RESULT    _IOWR('x', 198, struct rsi_cloak)

#define RSIIO_CHANNEL_WRITE    _IOWR('x', 199, struct rsi_cloak)
#define RSIIO_CHANNEL_READ    _IOWR('x', 200, struct rsi_cloak)
