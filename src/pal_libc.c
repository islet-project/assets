...
//extern unsigned long asm_memcpy(unsigned long dst, unsigned long src, unsigned long len);
...
{
  //return (void *)asm_memcpy((unsigned long)dst, (unsigned long)src, (unsigned long)len);
